...
import com.example.realestatemanager.ui.app.App
import com.openclassrooms.realestatemanager.ui.theme.Theme
...
private fun areLocationPermissionsAlreadyGranted(): Boolean {
    return ContextCompat.checkSelfPermission(
        AppSingleton.applicationInstance,
        Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
}

/*private fun openApplicationSettings() {
    Intent(ContactsContract.Settings.ACTION_APPLICATION_DETAILS_SETTINGS, Uri.fromParts("package", packageName, null)).also {
        startActivity(it)
    }
}*/
